...
def parse_args():
    ...
    # datasets
    parser.add_argument("--train_json_dir", type=str, default="../open/5fold/train.json")
    ...
    # --model keys
    parser.add_argument('--imgsz_w', type=int, default=1920) # 1920 # 1024
    parser.add_argument('--imgsz_h', type=int, default=1040) # 1040 # 555
    ...
    parser.add_argument('--lrf', type=float, default=5e-3)
    parser.add_argument('--momentum', type=float, default=0.937)
    parser.add_argument('--weight_decay', type=float, default=0.0005)
    parser.add_argument('--warmup_epochs', type=int, default=5)
    parser.add_argument('--warmup_momentum', type=float, default=0.0)
    parser.add_argument('--warmup_bias_lr', type=float, default=3e-3)

    parser.add_argument('--box', type=float, default=7.5) # default 7.5
    parser.add_argument('--cls', type=float, default=1) # default 0.5
...
if __name__ == '__main__':
    ...
    # model = YOLO('./yolov8x/fold4_230611_001435/weights/' + args.model)
